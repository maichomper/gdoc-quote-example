...
class QuoteBuilder:
    ...
    This builder provides a fluent interface for creating complex quote documents
    step by step. Each method returns self to allow method chaining.
    ...
    def with_header(self):
        """
        Add company header information including logo and contact details.
    ...
    def with_customer_info(self, customer_data, quote_data):
        ...
        Returns:
            self: Returns the builder instance for method chaining
        """
        add_customer_info_section(self.doc, customer_data, quote_data)
        return self
    ...
    def with_summary(self, summary):
        ...
        Args:
            summary: Dictionary containing subtotal, discount, total, anticipo
    ...
    def with_footer(self, footer_text=None):
        ...
        Args:
            footer_text: Optional custom footer text. If None, uses default locations.

        Returns:
            self: Returns the builder instance for method chaining
        """
        if footer_text is None:
            footer_text = 'POLANCO - ALTAVISTA - LOMAS - INTERLOMAS - PUEBLA - CANCÚN - CUERNAVACA - GUADALAJARA - LOS CABOS'
    ...
    def save(self, output_filename='quote_example.docx'):
        """
...
def generate_quote_docx(output_filename='quote_example.docx'):
    """
    Main function to generate the quote document using the Builder pattern.
    """
